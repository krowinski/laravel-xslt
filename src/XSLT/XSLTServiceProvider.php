...
class XSLTServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        {
            $factory = new SmartyFactory($app['view.engine.resolver'], $app['view.finder'], $app['events'], new Smarty, $this->app['config']);
        ...
        $this->app['view']->addExtension($this->app['config']->get('laravel-smarty.extension', 'tpl'), 'smarty', function ()
        {
    ...
    protected function registerCommands()
    {
        ...
        $this->app['command.ytake.laravel-smarty.info'] = $this->app->share(function ()
        {
